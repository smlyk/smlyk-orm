...
public class ClassMappings {
    ...
    static final Set<Class<?>> SUPPORT_SQL_OBJECTS = new HashSet<>();
    ...
    static {
        ...
        SUPPORT_SQL_OBJECTS.addAll(Arrays.asList(classes));
    }

    static boolean isSupportedSQLObject(Class<?> clazz){
        return clazz.isEnum() || SUPPORT_SQL_OBJECTS.contains(clazz);
    }

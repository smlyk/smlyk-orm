...
public interface BaseDao<T, PK> {
     ...
     * @throws Exception
     */
    Page<?> select(QueryRule queryRule,int pageNumber, int pageSize) throws Exception;
     ...
     * @throws Exception
     */
    Page<Map<String, Object>> selectBySqlToPage(String sql, Object[] param, int pageNumber, int pageSize) throws Exception;
